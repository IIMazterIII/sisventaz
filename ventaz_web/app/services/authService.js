'use strict';
ventazApp.factory('authService', ['$http', '$q', 'localStorageService', 'config', function ($http, $q, localStorageService, config) {
    ...
    function getUserInfo() {
        return $http.get(serviceBase + 'accounts/clientes/1/');
    }
